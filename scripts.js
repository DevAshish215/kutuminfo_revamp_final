...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (lastPage === currentPage && sessionStorage.getItem('scrollPosition')) {
...
function loadComponents() {
    // Load navbar
    fetchComponent(getBasePath() + "navbar.html", "navbar-placeholder")
        .then(() => {
    ...
    // Load footer
    fetchComponent(getBasePath() + "footer.html", "footer-placeholder");
}
